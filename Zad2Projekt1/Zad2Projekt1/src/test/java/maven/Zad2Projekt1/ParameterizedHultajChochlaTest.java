...
public class ParameterizedHultajChochlaTest {
	...
	return Arrays.asList(new Object[][] {
	 ...
	 public ParameterizedHultajChochlaTest(Integer input, Integer expected)
	 {
		 this.input = input;
	 ...
	 public void HultajChochlaTest() throws NieudanyPsikusException
	 {
	     ...
	     assertEquals(expected, p.HultajChochla(input));
	 }
}
